...
[bulwarkBox, ["<t color='#00ffff'>" + "Pickup", "bulwark\moveBox.sqf","",1,false,false,"true","not (player getVariable 'isCurrentlyHoldingObject')",2.5]] remoteExec ["addAction", 0, true];
[bulwarkBox, ["<t color='#00ff00'>" + "Shop", "[] spawn bulwark_fnc_purchaseGui; ShopCaller = _this select 1","",1.5,false,false,"true","not (player getVariable 'isCurrentlyHoldingObject')",2.5]] remoteExec ["addAction", 0, true];
